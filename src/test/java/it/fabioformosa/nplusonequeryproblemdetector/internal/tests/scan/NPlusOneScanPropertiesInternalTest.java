...
class NPlusOneScanPropertiesInternalTest {
    ...
    void givenNoProperties_whenLoaded_thenScanModeIsDisabledByDefault() {
        ...
        Assertions.assertThat(properties.reportOutput()).isEqualTo(NPlusOneScanReportOutput.LOGGER);
    }
    ...
    void givenCustomProperties_whenLoaded_thenValuesAreBoundFromEnvironment() {
        MockEnvironment environment = new MockEnvironment()
                ...
                .withProperty("n-plus-one-query-detector.scan.report.output", "stdout")
        ...
        Assertions.assertThat(properties.reportOutput()).isEqualTo(NPlusOneScanReportOutput.STDOUT);
